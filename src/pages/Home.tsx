...
export const Home = () => {
  const bfsiItems: BfsiFeature[] = [
    {
      ...
      image:
        "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/Screenshot-2026-03-01-000025.webp",
    },
    {
      title: "Customer Experience",
      image:
        "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/Screenshot-2026-02-28-235940.webp",
    },
    {
      title: "Operational Efficiency",
      image:
        "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/Screenshot-2026-03-01-000036.webp",
    },
  ];
  ...
  const tickerLogos = [
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a922f3b8543cf61d719_Meta.webp",
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a927c792072df0161d6_n8n.webp",
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a9220390d212ed84353_MCP.webp",
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a92ecfb9355bc15a244_Deepgram.webp",
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a929821752bd48b94fe_LangChain.webp",
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a927db35245931058ee_elevenlabs.webp",
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a9214d0c503d4b81de2_Gemini.webp",
    "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/69394a922f4a689ff1ee7700_Qwen.webp",
  ];
  ...
  const nextSlide = () =>
    setCurrentSlide((prev) => (prev + 1) % stratonCards.length);
  const prevSlide = () =>
    setCurrentSlide(
      (prev) => (prev - 1 + stratonCards.length) % stratonCards.length,
    );
  ...
  const frames: FrameData[] = [
    {
      id: "hero",
      className:
        "relative bg-[#1A0905] min-h-[calc(100vh-100px)] flex items-stretch overflow-hidden",
      content: (
        <>
          ...
          <div className="relative z-10 w-full flex flex-col lg:flex-row p-4 gap-4">
            <div className="lg:w-[55%] p-8 md:p-16 flex flex-col justify-center">
              <BlurHeading
                as="h1"
                className="text-5xl md:text-6xl lg:text-[5rem] font-medium text-white leading-[1.05] tracking-tight"
              >
                Production-ready
                <br />
                AI Solutions
            ...
            <div className="lg:w-[45%] relative min-h-[400px] lg:min-h-full flex items-center justify-center overflow-hidden rounded-[20px]">
              <video
                ...
                preload="auto"
                // @ts-expect-error - not in react types
                fetchPriority="high"
                poster="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/vidThumb.webp"
              >
                <source
                  src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/vid.webm"
                  type="video/webm"
                />
              </video>
              <div className="absolute inset-0 bg-gradient-to-r from-[#1A0905]/80 via-transparent to-transparent z-10"></div>
              <div className="absolute top-8 right-8 z-20">
                <p className="text-brand-orange font-medium tracking-widest uppercase text-sm bg-[#1A0905]/60 backdrop-blur-sm px-4 py-2 rounded-md border border-white/10">
                  NOT JUST PROTOTYPES.
                </p>
              </div>
            </div>
        ...
        <>
          <div className="lg:w-1/2 p-12 md:p-20 border-b lg:border-b-0 lg:border-r border-white/10 relative z-10 bg-[#1A0905] flex flex-col justify-center">
            <BlurHeading className="text-3xl md:text-4xl font-medium text-white mb-6 leading-[1.2]">
              We build AI that understands the nuances of Banking, Financial
              Services, and Insurance.
            </BlurHeading>

            <p className="text-white/70 mb-12 text-sm md:text-base leading-relaxed max-w-lg">
              Our domain-specific models are trained on industry data to ensure
              compliance, enhance customer journeys, and streamline complex
            ...
            <div className="space-y-[22.8px] mb-12">
              {bfsiItems.map((item, i) => (
                ...
                >
                  <div
                    className={`flex items-center justify-between transition-colors ${activeBfsi === item.title ? "text-brand-orange" : "text-white/70 group-hover:text-brand-orange"}`}
                  >
                    <span className="text-lg font-medium">{item.title}</span>
                    <ArrowRight
                      className={`w-5 h-5 transition-opacity ${activeBfsi === item.title ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`}
                    />
                  </div>
                </div>
              ))}
    ...
    },
    {
      id: "ai-stack-ticker",
      className:
        "bg-white p-8 md:p-12 flex flex-col items-center overflow-hidden",
      content: (
        <>
          <h3 className="text-[10px] font-bold tracking-[0.2em] uppercase mb-8 text-[#6E6E6E]">
            AI STACK
          </h3>
          <div className="w-full overflow-hidden relative">
            <div className="flex w-[200%] animate-ticker items-center">
              {[...tickerLogos, ...tickerLogos].map((logo, i) => (
                <div
                  key={i}
                  className="w-1/8 flex justify-center px-8 shrink-0"
                >
                  <img
                    src={logo}
                    alt="Partner Logo"
                    className="h-8 md:h-12 object-contain grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all"
                  />
                </div>
              ))}
            </div>
    ...
    },
    {
      id: "value-prop",
      className:
        "relative bg-[#1A0905] flex flex-col lg:flex-row overflow-hidden",
      content: (
        <>
          ...
          <div className="lg:w-1/2 p-12 md:p-20 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-white/10 relative z-10">
            ...
            <p className="text-white/70 text-lg leading-relaxed max-w-md">
              ...
              existing infrastructure, delivering rapid ROI and sustainable
              growth.
            </p>
          </div>
          ...
          <div className="lg:w-1/2 p-8 md:p-12 bg-[#2A0F08]/80 backdrop-blur-sm flex flex-col gap-[22.8px] relative z-10">
            {[
              ...
              <RiseCard
                key={i}
                delay={i * 0.15}
                className="bg-[#1A0905] border border-brand-orange/30 rounded-[20px] p-8 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300"
              >
                <CardCube />
    ...
    },
    {
      ...
      className:
        "relative bg-gradient-to-br from-[#FF4D2E] via-[#ff6b52] to-[#ff8f7a] text-white px-12 py-24 md:px-20 md:py-32 animate-gradient overflow-hidden",
      content: (
        <>
          <img
            src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/output-onlinepngtools.webp"
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-[60.8px] lg:gap-[91.2px] items-start">
            ...
            <div className="flex-1 flex flex-col gap-[38px] text-2xl md:text-3xl font-light tracking-wide max-w-xl relative">
              ...
              <p className="leading-snug">
                Your customers now expect instant answers, personalized
                experiences.
              </p>
              <p className="leading-snug">
                If you fail to deliver that, you're not just behind in tech,
                you're behind in relevance, altogether.
              </p>
              <p className="opacity-80 leading-snug">
                Building upon what works is not always a bad idea.
              </p>
              <p className="opacity-50 leading-snug">
                Because when you sprint in the right direction, you reach the
                right destination fast, and sometimes, even first.
              </p>
            </div>
          </div>
        </>
    ...
    },
    {
      id: "opportunities",
      className:
        "relative bg-[#1A0905] text-white p-12 md:p-20 overflow-hidden",
      content: (
        <>
          <div className="absolute inset-0 bg-reference-grid z-0 pointer-events-none opacity-50"></div>
                ...
                <div className="relative bg-[#2A0F08] border border-[#FF4D2E]/20 rounded-[18px] flex flex-col min-h-[420px] hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(255,77,46,0.15)] transition-all duration-300 cursor-pointer group overflow-hidden h-full">
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col z-30 pointer-events-none">
                    ...
                    <ul className="mt-6 space-y-3">
                      {opp.bullets.map((b, j) => {
                        const delays = [
                          "group-hover:delay-[330ms]",
                          "group-hover:delay-[410ms]",
                          "group-hover:delay-[490ms]",
                        ];
                        return (
                          <li
                            key={j}
                            className={`flex items-center gap-3 text-white text-sm opacity-0 translate-y-[8px] transition-all duration-[200ms] ease-in delay-0 group-hover:opacity-100 group-hover:translate-y-0 group-hover:duration-[300ms] group-hover:ease-out ${delays[j]} will-change-[opacity,transform]`}
                          >
    ...
    },
    {
      id: "straton-way",
      className:
        "relative bg-[#F3F3F3] text-[#111111] p-12 md:p-20 overflow-hidden",
      content: (
        <>
          ...
          <div className="mb-16 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-[38px] relative z-10">
            ...
            <p className="text-sm md:text-base max-w-[280px] text-right font-medium leading-relaxed">
              Every solution we build is designed to understand your business,
              anticipate challenges, and deliver business impact.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-[22.8px] mb-12 relative z-10">
            <RiseCard className="lg:col-span-8 relative rounded-[20px] overflow-hidden group h-[480px]">
              ...
              <div className="absolute bottom-8 left-8 bg-[#111111]/80 backdrop-blur-md p-8 rounded-xl max-w-sm border border-white/10">
                <div className="flex items-center gap-[11.4px] mb-5">
                  ...
                  <h4 className="text-white text-[11px] font-bold tracking-[0.15em] uppercase">
                    {stratonCards[currentSlide].title}
                  </h4>
                </div>
            ...
            <RiseCard
              delay={0.2}
              className="lg:col-span-4 relative rounded-[20px] overflow-hidden group h-[480px]"
            >
              <img
                src={
                  stratonCards[(currentSlide + 1) % stratonCards.length].image
                }
                alt={
                  stratonCards[(currentSlide + 1) % stratonCards.length].title
                }
                className="w-full h-full object-cover grayscale opacity-90 group-hover:scale-[1.03] transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
              <div className="absolute bottom-8 left-8 right-8 bg-[#111111]/80 backdrop-blur-md p-8 rounded-xl border border-white/10">
                <div className="flex items-center gap-[11.4px] mb-5">
                  ...
                  <h4 className="text-white text-[11px] font-bold tracking-[0.15em] uppercase">
                    {
                      stratonCards[(currentSlide + 1) % stratonCards.length]
                        .title
                    }
                  </h4>
                </div>
          ...
          <div className="flex justify-between items-center relative z-10">
            <div className="flex gap-[9.5px]">
              {stratonCards.map((_, idx) => (
                <div
                  key={idx}
                  className={`w-3.5 h-3.5 transition-colors ${idx === currentSlide ? "bg-brand-orange" : "bg-[#111111]"}`}
                ></div>
              ))}
            </div>
            <div className="flex gap-[11.4px]">
              <button
                onClick={prevSlide}
                className="w-12 h-12 bg-[#FF4D2E]/30 text-[#FF4D2E] flex items-center justify-center hover:bg-[#FF4D2E]/50 transition-colors rounded-sm"
              >
                <ArrowLeft className="w-5 h-5" />
              </button>
              <button
                onClick={nextSlide}
                className="w-12 h-12 bg-[#FF4D2E] text-white flex items-center justify-center hover:bg-[#e03a1f] transition-colors rounded-sm"
              >
    ...
    },
    {
      id: "ai-value",
      className:
        "relative bg-[#1A0905] py-32 px-12 md:px-20 flex items-center justify-center overflow-hidden",
      content: (
        <>
          <img
            src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/output-onlinepngtools.webp"
          ...
          <div className="relative z-10 max-w-[54rem] mx-auto text-center p-10 md:p-14">
            ...
            <ScrollFillText className="text-4xl md:text-5xl lg:text-[4rem] font-medium leading-[1.15] tracking-tight">
              AI is only valuable when it solves
              <br />
    ...
    },
    {
      id: "cta",
      className:
        "relative h-[400px] md:h-[500px] flex items-center px-12 md:px-24",
