  ...
  const stratonCards = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=2070&auto=compress&fit=crop",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1474487548417-781cb71495f3?q=80&w=2084&auto=compress&fit=crop",
    },
    {
      title: "SCALABLE ARCHITECTURE",
      desc: "Built on robust foundations that grow with your enterprise, ensuring long-term viability and performance.",
      image:
        "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=compress&fit=crop",
    },
  ];
  ...
  const frames: FrameData[] = [
    {
      id: "hero",
      className:
        "relative bg-[#1A0905] min-h-[600px] flex items-center overflow-hidden",
      content: (
        <>
          <img
            src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/Screenshot-2026-02-28-235957.webp"
            alt="Hero Background"
          ...
          <div className="relative z-10 w-full flex flex-col lg:flex-row">
            ...
            <div className="lg:w-[45%] relative min-h-[400px] lg:min-h-full flex items-center justify-center">
              ...
              <div className="absolute top-1/4 right-1/4 z-20">
                <p className="text-brand-orange font-medium tracking-widest uppercase text-sm">
                  NOT JUST PROTOTYPES.
                </p>
              </div>
