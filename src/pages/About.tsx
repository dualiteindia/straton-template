            ...
            {[
              {
                ...
                image: "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/693ffc4b094bb7d685c5fe02_Business.svg"
              },
              {
                title: "CO-CREATION",
                points: ["Solutions designed with you in the picture", "Defining clear success metrics of implementation"],
                image: "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/693ffc4b4451a568c8bffe02_Measuring.svg"
              },
              {
                ...
                image: "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/693ffc4bbd3dc8470212a328_Co-creation.svg"
              },
              {
                ...
                image: "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/693ffc4b8702afc0fa1c9784_Engineering.svg"
              }
            ].map((card, i) => (
        ...
        <div className="flex flex-col lg:flex-row gap-[30.4px] lg:gap-[45.6px] items-start">
          <div className="w-full lg:w-1/2 bg-[#F3F3F3] rounded-[20px] overflow-hidden flex flex-col sm:flex-row">
            <div className="sm:w-2/5 relative">
              <img 
                src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/cheerful-indian-businessman-smiling-closeup-portrait-jobs-career-campaign_53876-129417.avif" 
                alt="Himanshu Goyal" 
          ...
          <div className="w-full lg:w-1/2 bg-[#F3F3F3] rounded-[20px] overflow-hidden flex flex-col sm:flex-row lg:mt-24">
            <div className="sm:w-2/5 relative">
              <img 
                src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/straton-ai/closeup-young-hispanic-man-casuals-studio_662251-600.avif" 
